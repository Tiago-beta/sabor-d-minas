...
export default function HeaderCatalogoAtacado({ onCartClick, cartItemCount, whatsappNumber, titulo = "Catálogo Atacado" }) {

    const handleShare = () => {
        if (navigator.share) {
            navigator.share({
                title: "Pão D'Queijo e Cia - Catálogo Atacado",
                text: "Confira nossos produtos no atacado direto de Minas!",
