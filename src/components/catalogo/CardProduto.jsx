...
export default function CardProduto({ produto, onCardClick, onAddClick, carrinho }) {
    ...
    const precoVenda = produto.preco_varejo || 0;
    const precoOriginal = produto.preco_original_promocao; // This variable is still calculated but not used for display anymore
                ...
                <div className="flex-shrink-0">
                    {quantidade === 0 ? (
                        ...
                        <button
                            ...
                            className="bg-green-600 hover:bg-green-700 text-white rounded-full w-9 h-9 flex items-center justify-center font-bold text-sm transition-all"
                        >
                            {quantidade}
                        </button>
                    )}
